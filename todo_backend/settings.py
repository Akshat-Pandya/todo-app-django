...
SECRET_KEY = 'django-insecure-m80l#x4kr3(x6&bm3^&t&!f_x5wzcx56#9ch)v@0i94=u#u+pm'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['*']  # Allow all hosts for testing; later, restrict to your Render domain
